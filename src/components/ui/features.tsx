      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-black mt-4 mb-6">
            Built to Outlast the Indian Elements
          </h2>
        </div>
            ...
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`
                    flex lg:flex-row flex-col items-start space-x-4 p-4 max-w-sm md:max-w-sm lg:max-w-2xl transition-all duration-300
                    ${
                      isActive
                        ? "bg-surface text-on-surface md:shadow-xl rounded-xl"
                        : ""
                    }
                  `}
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className={`mt-4 rounded-sm h-1 overflow-hidden ${isActive ? 'bg-white/20' : 'bg-gray-200'}`}>
                        {isActive && (
                          <motion.div
